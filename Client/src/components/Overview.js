...
import {MDBCard, MDBCardBody, MDBCardText, MDBCol, MDBContainer, MDBIcon, MDBProgress} from 'mdbreact';
            ...
            <div className="overview row">
                <MDBCol className="col-md">
                    <MDBCard className="cascading-admin-card">
                        ...
                        <MDBCardBody>
                            <MDBProgress value={user.goal ? Math.floor(user.totalSavings / user.goal * 100) : 0}
                                         className="my-2"/>
                            <MDBCardText>{user.goal ? Math.floor(user.totalSavings / user.goal * 100) : 0}% to your
                                goal. Keep going!</MDBCardText>
                        </MDBCardBody>
                    </MDBCard>
                </MDBCol>
                <MDBCol className="col-md">
